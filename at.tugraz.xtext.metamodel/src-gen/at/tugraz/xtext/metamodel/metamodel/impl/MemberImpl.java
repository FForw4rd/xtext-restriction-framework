 ...
 * </p>
 * <ul>
 *   <li>{@link at.tugraz.xtext.metamodel.metamodel.impl.MemberImpl#getName <em>Name</em>}</li>
 *   <li>{@link at.tugraz.xtext.metamodel.metamodel.impl.MemberImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemberImpl extends MinimalEObjectImpl.Container implements Member
{
  ...
  public Type getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetamodelPackage.MEMBER__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(Type newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.MEMBER__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MetamodelPackage.MEMBER__NAME:
        return getName();
      case MetamodelPackage.MEMBER__TYPE:
