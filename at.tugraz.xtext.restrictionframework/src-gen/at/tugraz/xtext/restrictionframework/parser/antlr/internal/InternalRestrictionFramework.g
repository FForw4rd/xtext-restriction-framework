 ...
 * generated by Xtext
 */
grammar InternalRestrictionFramework;
...
@parser::members {
    ...
    public InternalRestrictionFrameworkParser(TokenStream input, RestrictionFrameworkGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected RestrictionFrameworkGrammarAccess getGrammarAccess() {
